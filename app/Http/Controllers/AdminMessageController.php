...
class AdminMessageController extends Controller
{
    ...
    // Create a new message in the database
        ...
        // Send an email notification to the admin - initial message
        Mail::to($adminEmail)->send(new AdminMessageNotification($adminMessage, $user, $userSubject));
    ...
    public function adminMessages()
    {
       ...
       $totalUnreadCount = $unreadMessagesCount + $unreadRepliesCount;
        ...
        return view('admin-panel.messages', compact('user', 'initialMessages', 'totalUnreadCount'));
    }
    ...
    public function storeAdminReply(Request $request, $messageId)
    {
        ...
        Mail::to($userEmail)->send(new AdminReplyNotification($user, $messageSubject, $reply->message, $message->id, $profileType));
