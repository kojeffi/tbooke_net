...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/feed', [FeedController::class, 'feeds'])->name('feed');
     Route::get('/feed-search', [FeedController::class, 'feed_search'])->name('feed-search');
    Route::get('/feed-details/{id}', [FeedController::class, 'show'])->name('feed-details');
    ...
    Route::get('/admin-panel/users', [AdminController::class, 'showUsers'])->name('admin-panel.users');
