...
<body>
	<main class="w-100 main-login">
		<div class="d-flex flex-column">
			<div class="row login-row">
			<div class="col-sm-8 col-md-6 mx-auto welcome-tbooke">
					...
					<div class="d-table-cell align-middle">
						<div class="text-center mt-4">
							<p class="lead">
								...
								Don't have an account? <span style="text-decoration: underline" ><a href="{{route('register')}}">Create Account</a></span>
							</p>
						</div>
