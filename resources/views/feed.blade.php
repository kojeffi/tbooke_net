											...
											<div class="d-flex align-items-start post-box" id="post-{{ $post->id }}">
												...
												<a href="{{ route('profile.showOwn') }}" class="user-image user-image-on-feed">
													@if ($post->reposter->profile_picture)
														<img src="{{ asset('storage/' . $post->reposter->profile_picture) }}" alt="Profile Picture" class="avatar img-fluid rounded-circle me-2" >
													@else
														<img src="{{ asset('/default-images/avatar.png') }}" alt="Default Profile Picture" class="avatar img-fluid rounded-circle me-2" >
													@endif
												</a>
												@else
												...
												@endif	
													...
													<div class="d-flex align-items-start mt-1 reposted_post">
														...
														<div class="flex-grow-1 reposted_post_media">
															...
															<p class="content-p">{!! nl2br(($post->originalPost->content)) !!}</p>
															@endif
