                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="o_sans o_text o_text-secondary o_px-md" align="center" style="font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 24px;color: #424651;padding-left: 24px;padding-right: 24px;">
                            <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 12px;">Dear {{ $followedUser->first_name }},</p>
                            <h2 class="o_heading o_mb-xxs" style="font-family: 'Roboto', sans-serif;margin-top: 0px;margin-bottom: 4px;font-weight: 700;color: #242b3d;font-size: 30px;line-height: 39px;">You have a new connection!</h2>
                            <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 4px;">You can view their profile <a href="{{ route('profile.show', $follower->username) }}">here</a>.</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
