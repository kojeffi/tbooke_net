                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="o_sans o_text o_text-secondary o_px-md" align="center" style="font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 24px;color: #424651;padding-left: 24px;padding-right: 24px;">
                            <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 12px;">Dear Tbooke Admin,</p>
                            <h2 class="o_heading o_mb-xxs" style="font-family: 'Roboto', sans-serif;margin-top: 0px;margin-bottom: 4px;font-weight: 700;color: #242b3d;font-size: 30px;line-height: 39px;">You have a new message!</h2>
                            <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 4px;">You can view their message <a href="{{ route('admin-panel.show', $adminMessage->id) }}">here</a>.</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
