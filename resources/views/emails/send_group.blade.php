...
<html lang="en">
  <head>
    ...
    <title>New Repost Notification</title>
    <style type="text/css">
              ...
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py-xl o_sans o_text-md o_text-dark" align="center" style="font-family: Helvetica, Arial, sans-serif;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #242b3d;padding-left: 24px;padding-right: 24px;padding-top: 48px;padding-bottom: 48px;">
                    <h2 class="o_heading o_text-secondary o_mb-xs" style="font-family: Helvetica, Arial, sans-serif;font-weight: 700;margin-top: 0px;margin-bottom: 8px;color: #424651;font-size: 30px;line-height: 39px;">Hi {{ $member->first_name }},</h2>
                    @if($type === 1)
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                      {{ $reposter->first_name }} {{$reposter->surname}},
                       Reposted  a post in your group. Click below to view it!
                      </p>
                     @endif
                    ...
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                      {{ $reposter->first_name }} {{$reposter->surname}}
                       Liked a post in your group. Click below to view it!
                      </p>
                     @endif
                    ...
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                      {{ $reposter->first_name }} {{$reposter->surname}},
                       Commented on  a post in your group . Click below to view it!
                      </p>
                     @endif
                    ...
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                      {{ $reposter->first_name }} {{$reposter->surname}}
                       Created  a post in your group!. Click below to view it!
                      </p>
                     @endif
                    ...
                    <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                      <tbody>
                        <tr>
                          <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: 700;margin-top: 0px;margin-bottom: 0px;background-color: #00509e;border-radius: 4px;">
                            <a class="o_text-white" href="#" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;font-size: 17px;line-height: 26px;">View Post</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
        ...
        <tr>
          <td class="o_bg-light o_px-xs o_pb-lg o_xs-pb-xs" align="center" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;padding-bottom: 32px;">
            <table class="o_block-xs" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;">
              <tbody>
                <tr>
                  <td class="o_re o_bg-white o_br-b o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;font-size: 14px;line-height: 21px;background-color: #ffffff;color: #82899a;border-radius: 0px 0px 4px 4px;">
                    <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">This email was sent to you because you subscribed to notifications on Tbooke.</p>
                    <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;"><a class="o_text-light o_underline" href="#" style="text-decoration: underline;outline: none;color: #82899a;">Unsubscribe</a></p>
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">&copy; {{ date('Y') }} Tbooke. All rights reserved.</p>
                  </td>
                </tr>
              </tbody>
            </table>
