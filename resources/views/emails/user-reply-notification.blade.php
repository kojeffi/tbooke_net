              ...
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py-xl o_sans o_text-md o_text-dark" align="center" style="font-family: Helvetica, Arial, sans-serif;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #242b3d;padding-left: 24px;padding-right: 24px;padding-top: 48px;padding-bottom: 48px;">
                    <h2 class="o_heading o_text-dark o_mb-xs" style="font-family: Roboto, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 8px;color: #242b3d;font-size: 30px;line-height: 39px;">Dear Tbooke Admin</h2>
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">You have received a new message from <strong>
                      ...
                      <tbody>
                        <tr>
                          <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center" style="font-family: Roboto, sans-serif;margin-top: 0px;margin-bottom: 0px;font-weight: bold;background-color: #242b3d;border-radius: 4px;">
                            <a class="o_text-white" href="{{ route('admin-panel.show', $messageId) }}" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;font-size: 17px;line-height: 26px;">View Message</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
