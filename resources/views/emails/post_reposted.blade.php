              ...
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py-xl o_sans o_text-md o_text-dark" align="center" style="font-family: Helvetica, Arial, sans-serif;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #242b3d;padding-left: 24px;padding-right: 24px;padding-top: 48px;padding-bottom: 48px;">
                    <h2 class="o_heading o_text-secondary o_mb-xs" style="font-family: Helvetica, Arial, sans-serif;font-weight: 700;margin-top: 0px;margin-bottom: 8px;color: #424651;font-size: 30px;line-height: 39px;">Hi {{ $post->user->first_name }}, You've got a new repost on your post!</h2>
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">{{ $reposter->first_name }} {{$reposter->surname}} reposted your post. Click below to view it!</p>
