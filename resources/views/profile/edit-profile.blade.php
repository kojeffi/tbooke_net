                            ...
                            <div class="card-body text-center">
                                <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" id="profile_form">
                                    ...
                                    @if ($user->profile_picture)
                                        <img id="profile-image" src="{{ asset('storage/' . $user->profile_picture) }}" alt="Profile Picture" class="img-fluid rounded-circle mb-2 profile-picture" width="128" height="128">
                                    @else
                                        <img id="profile-image" src="{{ asset('/default-images/avatar.png') }}" alt="Default Profile Picture" class="img-fluid rounded-circle mb-2 profile-picture" width="128" height="128">
                                    @endif
